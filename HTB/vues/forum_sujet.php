            ...
            <table>
                ...
                while ($donnees = $req->fetch()) {
                 ...
                 <tr>
                    ...
                    </br> par : <a class="pseudo" href="?p=profil&id=<?php echo $donnees6['id_user'] ?>"><?php echo $donnees6['pseudo'];?></a>  <?php echo $date->format('d/m/Y H:i:s');?></td>
                    <?php echo '<td class="nbrsujet">'. $donnees2['nb_message'].'</td>'; ?>
                    <td class="deniermessage"><a class="pseudo" href="?p=profil&id=<?php echo $dn['id_user'] ?>"><?php echo $donnees3['pseudo'];?></a></br>
                    <?php 
